 ...
 const timeNow = moment.tz("Asia/Ho_Chi_Minh").format("HH:mm:ss - DD/MM/YYYY");
  ...
  const {
    ...
    if (type) {
        ...
        api.sendMessage({body: msg1 + msg, attachment: (await require('axios').get(`https://i.imgur.com/16zL8fW.jpeg`, {
        responseType: 'stream'
    })).data
